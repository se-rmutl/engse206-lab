...
เอกสารชุดนี้ออกแบบให้ใช้ **กรณีศึกษา 1 เรื่องต่อ 1 กลุ่มตลอดภาคเรียน** เพื่อฝึกตาม flow งานจริงตั้งแต่  
...
|---|---|
| ภาพรวมรายวิชา ชั่วโมงเรียน และ flow ผลลัพธ์ | [Course Overview](docs/course-overview.md) |
