...
| Week | คำถามหลัก | ผลลัพธ์ | ส่งต่อไปยัง |
|---|---|---|---|
...
1. เปิด README ของ Week 02 และให้นักศึกษาเปรียบเทียบกับ Case ของตน
2. เปิดไฟล์ `.drawio` ใน [app.diagrams.net](https://app.diagrams.net) เพื่อดูว่าภาพ PNG มาจาก source ที่แก้ไขได้อย่างไร
3. ให้ผู้เรียนแทนที่ **เนื้อหาและเหตุผล** ด้วย Case ของกลุ่มตน ไม่ใช่เปลี่ยนเฉพาะชื่อระบบ
4. ใช้ Markdown และ diagram paths เดิม เพื่อให้อาจารย์ตรวจผ่าน GitHub ได้เป็นมาตรฐานเดียวกัน

## Draw.io เป็น source หลัก

- `.drawio` = ไฟล์ต้นฉบับที่แก้ไขต่อได้
- `.png` = ภาพ export สำหรับ preview บน GitHub / Markdown
- เมื่อแก้ diagram ต้อง commit ทั้ง **source** และ **PNG export** พร้อมกัน

> เนื้อหา บุคคล และหลักฐานในชุดนี้เป็นกรณีจำลองเพื่อการเรียนรู้ ไม่มีข้อมูลส่วนบุคคลจริง และไม่ใช่ข้อกำหนดจริงของมหาวิทยาลัย
