# Week 02: Workshop 1: Stakeholder and Context Mapping

## ข้อมูลสัปดาห์

| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 1.2 Problem Framing, Stakeholder, Scope และ Ethics |
| CLO | CLO1, CLO2 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Workshop + Context Mapping + Scope Clinic |
| ผลงานที่ต้องส่ง | Stakeholder Map + System Context + Scope Statement |

## เป้าหมายการเรียนรู้

วิเคราะห์ว่าใครได้รับผลกระทบ ใครตัดสินใจ และขอบเขตใดควรทำ/ไม่ทำ รวมถึง privacy/ethics
...
- Problem framing และเป้าหมายของระบบ
- Stakeholder analysis และ system context
- Scope, constraint, assumption, ethics/privacy
...
1. ทบทวน Problem Brief
2. สร้าง stakeholder map ด้วย influence/interest
3. วาด system context แบบง่าย
4. กำหนด in scope/out of scope/constraints
5. ตรวจ ethics/privacy แล้ว commit/push
