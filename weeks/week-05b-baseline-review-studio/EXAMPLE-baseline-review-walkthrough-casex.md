...
> **ถ้ารีโปของกลุ่มยังไม่มีไฟล์นี้** (กลุ่มที่สร้างรีโปก่อนไฟล์ถูกเพิ่มเข้า template) ให้ดาวน์โหลดแม่แบบเข้ารีโปตัวเองก่อน:
>
> ```bash
...
> ```
>
> หรือเปิด raw URL ข้างบนในเบราว์เซอร์ แล้วก็อปเนื้อหามาวางในไฟล์ใหม่ `submissions/baseline-review-submission.md`
