# Week 07: LAB 1: SRS Authoring Studio
...
| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 4.1 SRS และ Requirement Specification |
| CLO | CLO3 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Document Studio + Instructor Checkpoints |
| ผลงานที่ต้องส่ง | SRS Draft v1 |

## เป้าหมายการเรียนรู้

นำ backlog และ model มาเรียบเรียงเป็น SRS กำหนด ID, source, priority, constraints และ verification idea
...
- โครงสร้าง SRS
- Requirement ID, source, priority, condition, verification
- คุณลักษณะ requirement ที่ดี
...
1. สร้าง SRS structure จาก template
2. เขียน FR/NFR พร้อม ID/source/priority
3. ตรวจความกำกวมด้วย checklist
4. teacher checkpoint สำหรับ 2–3 requirement สำคัญ
5. export/commit SRS draft v1
