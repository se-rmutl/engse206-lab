# Week 08: LAB 2: SRS Quality Clinic

## ข้อมูลสัปดาห์

| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 4.2 Validation, Traceability, Baseline และ Change Management |
| CLO | CLO4 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Peer Review + Traceability Lab + Change Scenario |
| ผลงานที่ต้องส่ง | Review Report + Traceability Matrix + Change Request |

## เป้าหมายการเรียนรู้

ใช้ checklist ตรวจคุณภาพ requirement สร้าง traceability และฝึกวิเคราะห์ผลกระทบเมื่อ requirement เปลี่ยน
...
- Peer review, traceability, baseline, change request
- Impact analysis
...
1. แลกเอกสารกับกลุ่ม reviewer
2. ใช้ requirement quality checklist
3. สร้าง traceability matrix
4. รับ change scenario และทำ impact analysis
5. แก้ SRS/บันทึก change request
