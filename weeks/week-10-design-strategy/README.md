# Week 10: Design Charrette and Project Coaching
...
| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 5.1 Design Strategy และ Design Rationale |
| CLO | CLO5 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Design Charrette + Coaching |
| ผลงานที่ต้องส่ง | Design Strategy Canvas + Rationale |

## เป้าหมายการเรียนรู้

แปลง requirement เป็นเป้าหมายการออกแบบ เลือกแนวทางเบื้องต้น และอธิบาย trade-off
...
- Design goals, constraints, responsibility allocation
...
1. เลือก design goals จาก priority requirements
2. ระบุ constraints/design drivers
3. สร้าง design strategy canvas
4. อภิปราย options และ trade-offs
5. project coaching แล้วบันทึก rationale
