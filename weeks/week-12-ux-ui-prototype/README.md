# Week 12: LAB 4: UX/UI Prototype Studio

## ข้อมูลสัปดาห์

| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 5.2 Human-centred UX/UI, Prototype และ Accessibility |
| CLO | CLO5, CLO6 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | User Flow + Wireframe/Prototype + Accessibility Check |
| ผลงานที่ต้องส่ง | Prototype + Usability Test Plan |

## เป้าหมายการเรียนรู้

ออกแบบ user flow และ prototype สำหรับ primary task พร้อมวางแผนทดสอบ usability
...
- Human-centred design and user tasks
...
1. กำหนด primary user task
2. สร้าง user flow
3. วาด wireframe/prototype 3–5 screens
4. ใช้ accessibility checklist
5. เขียน usability test plan
