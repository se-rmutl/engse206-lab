# Week 13: Detailed Design Studio
...
| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 6.1 Detailed Design: Component, Data, Interface และ Interaction |
| CLO | CLO5, CLO6 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Design Studio + Instructor Critique |
| ผลงานที่ต้องส่ง | Detailed Design Package v1 |

## เป้าหมายการเรียนรู้

ต่อยอด conceptual architecture เป็น component responsibility, data/interface contract, validation rules และ interaction flow
...
- Component responsibility, data/interface contracts
- Interaction flow and validation rules
...
1. เลือกส่วนงานสำคัญ 1–2 ส่วน
2. ระบุ component responsibility
3. ออกแบบ data/interface/API contract
4. เขียน sequence/interaction flow
5. instructor critique + revise
