# Week 14: Workshop 5: Peer Design Review Simulation

## ข้อมูลสัปดาห์

| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 6.1 Design Quality Criteria |
| CLO | CLO4, CLO6 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Peer Review Simulation + Improvement Backlog |
| ผลงานที่ต้องส่ง | Design Review Report + Improvement Backlog |

## เป้าหมายการเรียนรู้

ใช้ rubric ตรวจ requirement coverage, feasibility, usability/accessibility, privacy/security และ maintainability
...
- Review rubric and feedback methods
- Improvement backlog
...
1. แลก design package กับกลุ่ม reviewer
2. ใช้ rubric และ evidence-based feedback
3. จัด severity ของข้อค้นพบ
4. สร้าง improvement backlog
5. กำหนด owner และ target version
