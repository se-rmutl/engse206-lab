...
| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 6.2 Usability Evidence, Refinement และ Traceability |
| CLO | CLO4, CLO6 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Usability/Peer Test + Revision Clinic |
| ผลงานที่ต้องส่ง | Test Evidence + Revised Requirement-to-Design Package |

## เป้าหมายการเรียนรู้

รับ feedback ดำเนิน test วิเคราะห์ข้อค้นพบ และปรับเอกสาร/แบบออกแบบพร้อมบันทึก rationale
...
- Usability/peer test planning
- Observation and evidence analysis
- Iteration and revision rationale
...
1. เตรียม task scenario สำหรับ peer test
2. ทำ usability/peer test
3. บันทึก observation แยกจาก interpretation
4. วิเคราะห์ issue และปรับแบบออกแบบ
5. อัปเดต traceability/rationale
