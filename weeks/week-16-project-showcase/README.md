# Week 16: Requirement-to-Design Showcase

## ข้อมูลสัปดาห์

| รายการ | รายละเอียด |
|---|---|
| บทเรียน | 6.2 Integration, Design Pitch และ Reflection |
| CLO | CLO4–CLO6 |
| เวลา | ทฤษฎี 2 ชั่วโมง + ปฏิบัติ/กิจกรรม 3 ชั่วโมง |
| รูปแบบ | Project Showcase + Individual Reflection |
| ผลงานที่ต้องส่ง | Final Package + Presentation + Reflection |

## เป้าหมายการเรียนรู้

นำเสนอผลงานรวม อธิบายเหตุผลการออกแบบ ข้อจำกัด และวิธีใช้ feedback ปรับปรุงงาน
...
- Design pitch narrative
- Reflection and professional communication
...
1. ตรวจ final checklist
2. จัดลำดับ story ของ design pitch
3. นำเสนอ Requirement-to-Design Package
4. รับ peer/instructor feedback
5. ทำ individual reflection และ tag/release
